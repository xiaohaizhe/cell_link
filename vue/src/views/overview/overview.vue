<template>
  <div class="overview">
    <div class="cl-flex head">
        ...
        <el-button type="text" style="padding:0;color:#BACBDB" @click="$router.push('/login')">登录</el-button>
    </div>
    ...
    <div class="dataCenter">
      ...
      <div class="content">
        <div v-for="item in globalData" :key="item.text">
          ...
          <div class="number">
            <p class="font-48"><count-to :start-val="0" :end-val="item.total" :duration="2600"/></p>
    ...
    <div class="infos center">
     ...
     <template>
        <el-backtop target=".overview"></el-backtop>
    </template>
  </div>
</template>
        ...
        infos:[
          {
            ...
            img: require('assets/calculate.svg'),
            text: "无处不在的计算",
