            ...
            <div>
                ...
                <div v-show="activeTab==0">
                    <div class="searchArea flexBtw">
                        <el-input placeholder="输入设备ID或者设备名称后按回车键"  v-model="triggerKey" @keyup.enter.native="changeTriKey()" 
                            clearable style="width:320px;height:36px;"></el-input>
                        <el-button>一键关联</el-button>
                    </div>
                    <div class="cl-table">
                                    ...
                                    <template slot-scope="scope">
                                        <div class="rowData flex cl-card">
                                            ...
                                            <div>
                                                ...
                                                <p class="colorGray">设备ID：{{scope.row.deviceId}}</p>
